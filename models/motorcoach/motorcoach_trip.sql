...
e.state as company, '' as trip_status, e.miles as distance, e.seats_occupied as _Occ_Max, e.total_seats as _Seat_Total,

'True' as is_active, e.time_travel as _Hora_Salida,  e.departure as _Origen, e.arrival as _Destino,
