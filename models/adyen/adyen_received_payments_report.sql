...
select
    ...
    COALESCE(CAST("authorisation_code" as VARCHAR), '') as authorisation_code,
    ...
    COALESCE("delivery_postal_code___zip", '')          as delivery_postal_code___zip,
...
from public.adyen_received_payments_report