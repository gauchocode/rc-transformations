...
select 
        ...
        CAST("gross_debit_gc" as double)                            as gross_debit_gc,
        CAST("gross_credit_gc" as double)                           as gross_credit_gc,
        CAST("exchange_rate" as double)                             as exchange_rate,
        COALESCE("net_currency", '')                                as net_currency,
        CAST("net_debit_nc" as double)                              as net_debit_nc,
        CAST("net_credit_nc" as double)                             as net_credit_nc,
        CAST("commission_nc" as double)                             as commission_nc,
        CAST("markup_nc" as double)                                 as markup_nc,
        CAST("scheme_fees_nc" as double)                            as scheme_fees_nc,
        CAST("interchange_nc" as double)                            as interchange_nc,  
        ...
        CAST("batch_number" as long)                            as batch_number,
        ...
        CAST("payment_fees_nc" as double)                           as payment_fees_nc,
