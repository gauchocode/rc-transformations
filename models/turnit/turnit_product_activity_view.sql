...
select 
    ...
    COALESCE(replace("OriginStopCode", 'UCL', 'UFL'), replace("OriginStopCode", 'FMP', 'FM'))                           as origin_stop_code,
    ...
    COALESCE(replace("DestinationStopCode", 'UCL', 'UFL'), replace("DestinationStopCode", 'FMP', 'FM'))                 as destination_stop_code,
    "IsInboundJourneyWay"                                                                                               as is_inbound_journey_way,
    COALESCE(replace("JourneyOriginStopCode", 'UCL', 'UFL'), replace("JourneyOriginStopCode", 'FMP', 'FM'))             as journey_origin_stop_code,
    ...
    COALESCE(replace("JourneyDestinationStopCode", 'UCL', 'UFL'), replace("JourneyDestinationStopCode", 'FMP', 'FM'))   as journey_destination_stop_code,
