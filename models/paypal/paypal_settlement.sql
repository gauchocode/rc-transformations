...
select 
    ...
    to_timezone("Transaction_Initiation_Date", 'YYYY-MM-DD"T"HH24:MI:SS') AT TIME ZONE 'UTC'        as transaction_initiation_date_utc,
    "Transaction_Completion_Date"                                                                   as transaction_completion_date,
    to_timezone("Transaction_Completion_Date", 'YYYY-MM-DD"T"HH24:MI:SS') AT TIME ZONE 'UTC'        as transaction_completion_date_utc,
