...
select 
    ...
    CAST(transaction_info->'transaction_initiation_date' as DATE)                       as transaction_initiation_date,
    CAST(transaction_info->'transaction_updated_date' as DATE)                          as transaction_completion_date,
