...
select 
    ...
    to_timestamp("Transaction_Initiation_Date", 'YYYY-MM-DD"T"HH24:MI:SS')                          as transaction_initiation_date,
    to_timestamp("Transaction_Initiation_Date", 'YYYY-MM-DD"T"HH24:MI:SS') AT TIME ZONE 'UTC'       as transaction_initiation_date_utc,
    to_timestamp("Transaction_Completion_Date", 'YYYY-MM-DD"T"HH24:MI:SS')                          as transaction_completion_date,
